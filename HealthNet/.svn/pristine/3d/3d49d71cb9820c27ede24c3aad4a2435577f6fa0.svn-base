...
def index(request):
    ...
    pOd = 'admin' if 'auth.patient' in permissions and 'auth.doctor' in permissions else 'patient' if 'auth.patient' in permissions else 'doctor' if 'auth.doctor' in permissions else 'nurse'
