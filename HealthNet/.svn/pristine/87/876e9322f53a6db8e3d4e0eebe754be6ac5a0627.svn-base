...
/resources - a directory containing webpage resources
/healthcare_StackOverflowGooglers.zip - an archive containing our code and some utilities to help run it
/index.html - a webpage to download these files from
/R2_Requirements-HealthNet.pdf - a document describing teh required functionality of this project
/README.txt - this document, which describes the project and how to use it
/TestPlanTracker_R2.xls - an Excel spreadsheet for marking down the results of your tests
