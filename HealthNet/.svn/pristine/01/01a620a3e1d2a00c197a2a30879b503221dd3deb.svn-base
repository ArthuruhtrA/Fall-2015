...
class Prescription(models.Model):
    ...
    def __str__(self):
        return str(self.doctor) + " prescribed " + str(self.name) + " to you at " + str(self.dateTime) + " because of " + str(self.reason)
...
class PatientTest(models.Model):
    ...
    def __str__(self):
        return str(self.doctor) + " tested " + str(self.name) + " to you at " + str(self.dateTime) + " because of " + str(self.details)
...
class AdminNewsFeed(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    dateTime = models.DateTimeField()
    message = models.CharField(max_length=1000)
