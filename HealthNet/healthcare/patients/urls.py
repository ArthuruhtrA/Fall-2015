...
urlpatterns = [
    ...
    url(r'^messageboard/$', views.AdminMessageBoard, name='AdminMessageBoard'),
    ...
    url(r'^doctoredittransferpatient/(?P<text>[a-z A-Z 0-9 -]+)/$', views.DoctorEditTransferPatient, name='DoctorEditTransferPatient'),
    url(r'^viewpatient/(?P<text>[a-z A-Z 0-9 -]+)/$', views.DoctorViewPatientDetails, name='DoctorViewPatientDetails'),
    url(r'^prescribe/(?P<text>[a-z A-Z 0-9 -]+)/$', views.DoctorPrescribe, name='DoctorPrescribe'),
    url(r'^releasetest/(?P<text>[a-z A-Z 0-9 -]+)/$', views.DoctorReleaseTest, name='DoctorReleaseTest'),
    url(r'^addfile/(?P<text>[a-z A-Z 0-9 -]+)/$', views.DoctorAddFile, name='DoctorAddFile'),
    ...
    url(r'^patientexportinfo/$', views.PatientExportInfo, name='PatientExportInfo'),
